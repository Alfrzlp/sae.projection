...
#' @md
projection <- function(
    formula, id, weight, strata = NULL, domain, model,
    data_model, data_proj, model_metric, kfold = 1, grid = 1, parallel_over = "resamples", seed = 1, ...
  ){
  ...
  svy1_design <- survey::svydesign(ids = id, weights = weight, strata = strata, data = data_proj, nest = TRUE, ...)
